/battle_data/player
	...
	var/obj/battle_icon/healthbar/minion_health
	var/obj/battle_icon/healthbar/enemy/enemy_health
...
/battle_data/player/New(var/battle/_battle, var/mob/_owner)
	...
	minion_health = new /obj/battle_icon/healthbar(src)
	enemy_health = new /obj/battle_icon/healthbar/enemy(src)
	hp_objects += minion_health
	hp_objects += enemy_health
	hp_objects += minion_health.mask
	hp_objects += enemy_health.mask
	hp_objects += minion_health.bar
	hp_objects += enemy_health.bar
...
/battle_data/player/update(var/update_minon, var/update_opponent)
...
/battle_data/player/battle_ended()
	...
	animate(minion_health, alpha = 0, time = 5)
	animate(enemy_health, alpha = 0, time = 5)
	animate(minion_health.mask, alpha = 0, time = 5)
	animate(enemy_health.mask, alpha = 0, time = 5)
	animate(minion_health.bar, alpha = 0, time = 5)
	animate(enemy_health.bar, alpha = 0, time = 5)
