...
/obj/battle_icon/menu/New(var/data/battle_data/_battle)
	battle = _battle
...
/obj/battle_icon/menu/tech/proc/update_tech(var/data/technique/_tech)
	maptext = null
	tech = _tech
...
/data/battle_data/proc/start_turn()
	next_action = null
	taking_commands = 1

/data/battle_data/proc/end_turn()
	taking_commands = 0
